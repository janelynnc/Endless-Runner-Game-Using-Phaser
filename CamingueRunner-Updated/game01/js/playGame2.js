...
myGame.playGame2=function(){};
myGame.playGame2.prototype={
	

	create: function(){
		// This is the main sound for this level.
		this.music2=new Phaser.Sound(this.game, 'gameMusic2', 1, true);
		this.music2.play();
		// This is the sound for earning a point.
		this.score_music2=new Phaser.Sound(this.game, 'scorePointSound', 1, false);	
	    // This is for making the background look "endless" and repeating.
		this.background=this.game.add.tileSprite(0,0,this.game.world.width, this.game.world.height,'backdrop2');	
		...
		this.highscoreText = this.game.add.text(16, 45, 'Best: '+this.highScore, { fontSize: '32px', fill: '#000' });
	...
	update: function(){
		...
		this.highscoreText.text='Best: '+localStorage.getItem('highScore');
