...
myGame.playGame1=function(){};
myGame.playGame1.prototype={
	

	create: function(){
		this.music1=new Phaser.Sound(this.game, 'gameMusic1', 1, true);
		this.music1.play();
		
		this.score_music1=new Phaser.Sound(this.game, 'scorePointSound', 1, false);
		
	    // This is for making the background look "endless" and repeating.
		this.background=this.game.add.tileSprite(0,0,this.game.world.width, this.game.world.height,'backdrop1');
