...
myGame.playGame.prototype={
	...
	create: function(){
		// This is the main music for this level.
		this.music=new Phaser.Sound(this.game, 'gameMusic', 1, true);
		this.music.play();
		// This is the sound effect for earining a point.
		this.score_music=new Phaser.Sound(this.game, 'scorePointSound', 1, false);
        ...
        this.highscoreText = this.game.add.text(16, 45, 'Best: '+this.highScore, { fontSize: '32px', fill: '#fff' });
